...
const DiscordBox = () => {
  ...
  const handleClick = () => {
    window.open('https://discord.gg/mUm4hYvG3x', '_blank');
  };
  ...
  return (
    ...
    >
      ...
      <h3 className={styles.serverName}>Elmarath Community</h3>
      <p className={styles.callToAction}>Get support, share projects & connect</p>
